...
| `docs/orientation_agnostic_naming.md` | Brief for an agent investigating AceTree misnaming `ABal`/`ABar` + `ABpl`/`ABpr` in skewed-mounted embryos (outlier: `20260603_ceh-27_JIM593_L2`). Diagnosis is confirmed — naming is the sign of one dot product and the V1 AuxInfo scheme cannot represent a 3D mounting tilt. Phased plan; no code written yet. |
